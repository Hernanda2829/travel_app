...
class TransaksiScreen extends GetWidget<TransaksiController> {
  @override
        ...
        child: Scaffold(
                                ...
                                Container(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                                                  ...
                                                                  Padding(
                                                                      ...
                                                                      child: Text(
                                                                          ...
                                                                          textAlign: TextAlign
                                                                              .left,
                                                                          style:
                                                                              AppStyle.txtRobotoSlabRegular11))
                                                                ])),
                                                        CustomButton(
                                                            height: 36,
                                                            width: 116,
                                          ...
                                          Padding(
                                              padding:
                                                  getPadding(left: 20, top: 14),
                                              child: Text(
                                                  "msg_rincian_pembayaran".tr,
                                                  overflow:
                                                      TextOverflow.ellipsis,
                                                  textAlign: TextAlign.left,
                                                  style: AppStyle
                                                    ...
                                                    Padding(
                                                        ...
                                                        child: Text(
                                                            ...
                                                            textAlign:
                                                                TextAlign.left,
                                                            style: AppStyle
                                                                .txtRobotoSlabRegular12Black900)),
                                                    Padding(
                                                        padding:
                                                            getPadding(top: 1),
                                                        child: Text(
                                          ...
                                          Padding(
                                              padding: getPadding(
                                                  left: 19, top: 3, right: 44),
                                              child: Row(
                                                  mainAxisAlignment:
                                                      MainAxisAlignment
                                                          .spaceBetween,
                                                  children: [
                                                    Text("lbl_biaya_layanan".tr,
                                                        overflow: TextOverflow
                                                            .ellipsis,
                                                        textAlign:
                                                            TextAlign.left,
                                          ...
                                          CustomButton(
                                              height: 32,
                                              width: 190,
                                              text: "lbl_buat_pesanan".tr,
                                              margin:
                                                  getMargin(top: 18, bottom: 1),
                                              variant:
                                                  ButtonVariant.FillBlue800,
                                              shape: ButtonShape.CircleBorder16,
                                              fontStyle: ButtonFontStyle
                                                  .RobotoSlabBold12,
                                              onTap: onTapBuatpesanan,
                                              alignment: Alignment.center)
                                        ]))
                              ]))
                    ])),
            bottomNavigationBar: Container(
                ...
                child: Row(
                    ...
                    children: [
                      CustomImageView(
                          imagePath: ImageConstant.imgButonhome,
                      ...
                      CustomImageView(
                          imagePath: ImageConstant.imgButtonpencarian,
                          height: getVerticalSize(31.00),
                          width: getHorizontalSize(41.00),
                          margin: getMargin(left: 49, top: 10, bottom: 5),
                          onTap: () {
                            onTapImgButtonkategori();
                          }),
                      CustomImageView(
                          imagePath: ImageConstant.imgButonfolower,
                          height: getVerticalSize(41.00),
                          width: getHorizontalSize(50.00),
                          margin: getMargin(left: 42, top: 5),
                          onTap: () {
                            onTapImgButonTroli();
                          }),
                      CustomImageView(
                          imagePath: ImageConstant.imgButtonguest,
                          height: getVerticalSize(34.00),
                          width: getHorizontalSize(23.00),
                          margin: getMargin(left: 48, top: 10, bottom: 2),
                          onTap: () {
                            onTapImgButtonexit();
                          })
                    ]))));
